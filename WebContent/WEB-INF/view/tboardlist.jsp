				...
				<table>
					...
					<c:if test="${volist != null}">
						<c:forEach items="${volist}" var="vo">
							<tr>
								<td><a href="tboardcontent?no=${vo.tipNo }">${vo.tipNo }
								</a></td>
								<td><c:forEach begin="1" end="${vo.breLevel }" step="1">
			Re :
			</c:forEach></td>
								<td><a href="tboardcontent?no=${vo.tipNo }">${vo.tipTitle}</a></td>
