...
<body>
	...
	<div class="section">
		...
		<div class="article">
			<!-- 페이지의 메인 아티클 -->
			<h2 class="title">개발사게시판</h2>
			<form method="post" action="./gbboardwrite.do"
				enctype="multipart/form-data">
				<input type="hidden" name="bno" value="<%=bno%>" readonly> <select
					name="heading" id="select">
					<option value="wanted">구인</option>
					<option value="seek">구직</option>
					<option value="talk">잡담</option>
				</select><br> <input type="text" class="writetitle" autofocus
					name="title" placeholder="제목을 작성해주세요." required><br>
				<textarea class="writecontent" placeholder="내용을 작성해주세요."
					name="content" required></textarea>
				<br> <input type="file" name="uploadFile" /><br> <input
