...
<body>
	...
	<div class="section">
		...
		<div class="article">
			...
			<form method="post" action="./tboardwrite.do" enctype="multipart/form-data">
					<input type="hidden" name="bno" value="<%=bno%>" readonly>
					<input class="writetitle" type="text" autofocus name="title" placeholder="제목을 작성해주세요." required><br> 
						<textarea placeholder="내용을 작성해주세요." class="writecontent type="text" name="content" required></textarea><br>
					<input type="file" name="uploadFile"><br> 
					<input class="submit" type="submit" value="등록"> <input class="cancel" type="reset" value="취소">
			</form>
		</div>
	</div>
