...
CREATE TABLE GAME(
    ...
    CONSTRAINT GG_FK FOREIGN KEY(GD_GAMEDEVID)
...
CREATE TABLE GAME_IMAGE(
    ...
    CONSTRAINT GI_FK FOREIGN KEY(GG_NO)
...
CREATE TABLE MEMBERSHIP(
    ...
    CONSTRAINT MEMBERSHIP_FK1 FOREIGN KEY(GG_NO)
    REFERENCES GAME(GG_NO),
    CONSTRAINT MEMBERSHIP_FK2 FOREIGN KEY(GD_GAMEDEVID)
    REFERENCES GAME_DEV(GD_GAMEDEVID)
);
