...
/**
 * Servlet implementation class ShowPwdServlet
 */
@WebServlet("/showpwd")
public class ShowPwdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowPwdServlet() {
        super();
...
//		int bno = Integer.parseInt(id);
		...
		request.getRequestDispatcher("/WEB-INF/view/showPwd.jsp").forward(request, response);
	}
