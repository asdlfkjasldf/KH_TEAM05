...
public class Member {
	...
	public Member() {}
	public Member(String mm_id, String mm_pwd, String mm_email, String mm_phn, String mm_com, String mm_profile, String mm_nickname, String mm_membership) {
		this.mm_id = mm_id;
		this.mm_pwd = mm_pwd;
	...
	public String toString() {
		return "Member [mm_id=" + mm_id + ", mm_pwd=" + mm_pwd + ", mm_email=" + mm_email + ", mm_phn=" + mm_phn
				+ ", mm_com=" + mm_com + ", mm_enrolldate=" + mm_enrolldate + ", mm_profile=" + mm_profile
				+ ", mm_nickname=" + mm_nickname + ", mm_membership=" + mm_membership + "]";
	}
