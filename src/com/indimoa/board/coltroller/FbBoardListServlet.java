...
/**
 * Servlet implementation class FbBoardListServlet
 */
@WebServlet("/fbboardlist")
public class FbBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FbBoardListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/view/fbboardlist.jsp").forward(request, response);
